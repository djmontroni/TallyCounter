...
//
// MACROS - These definitions will save memory
//
#define LOW 0
#define HIGH 1
#define PHOTO_SENSOR 0
#define THRESHOLD_POT 1
...
bool is_pulse(byte thisState, byte lastState)
{
...
void loop() {
  ...
  int light_value        = analogRead(PHOTO_SENSOR);
  int threshold_value    = analogRead(THRESHOLD_POT);
